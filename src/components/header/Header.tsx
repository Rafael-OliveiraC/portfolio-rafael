    ...
    return(
        <header id='header'>
            <nav>
                <ul>
                    <li>
                        <a href='#skills'>{text[1]}</a>
                    </li>
                    <li>
                        <a href='#projects'>{text[2]}</a>
                    </li>
                    <li>
            ...
            <div>
                <ul>
                    ...
                    <li className='btnLanguage'>
                        <button onClick={() => props.language('PT')}>PT</button>
                        <button onClick={() => props.language('EN')}>EN</button>
                    </li>
                </ul>
            </div>
